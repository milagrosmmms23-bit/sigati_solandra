...
$assignmentCss = <<<'CSS'
<style>
@page{size:A4 portrait;margin:9mm 12mm 7mm}
...
.quality-sheet{width:100%;max-width:186mm;min-height:0;margin:0 auto;background:#fff;display:block}
.quality-table{width:100%;border-collapse:collapse;table-layout:fixed}
.quality-table td,.quality-table th{border:1px solid #222;padding:6px 7px;vertical-align:middle;line-height:1.24}
.quality-header{margin-bottom:8.5mm}
.quality-logo{width:24%;text-align:center;padding:0 4px;overflow:hidden}
.solandra-logo{width:40mm;max-width:100%;height:auto;display:block;margin:0 auto}
.quality-title{text-align:center;font-size:14px;font-weight:bold;color:#666;letter-spacing:0}
.quality-subtitle{text-align:center;font-size:14px;font-weight:bold;color:#666;letter-spacing:0}
.quality-meta{width:22%;font-size:10px;padding:0;line-height:1.06}
.quality-meta div{border-bottom:1px solid #222;padding:2px 4px}
.quality-meta div:last-child{border-bottom:0}
.quality-sign td{font-size:10px;height:auto;line-height:1.08;vertical-align:bottom;padding:2px 4px}
...
.equipment-table{margin-bottom:6.8mm;font-size:14px}
.equipment-table td{height:auto;min-height:0}
.observations{height:auto;vertical-align:top;line-height:1.2}
.assigned-title{font-weight:bold;margin:6.5mm 0 1.5mm 5mm;font-size:14px}
.assigned-table{margin-bottom:6.5mm;font-size:14px}
.legal-text{font-size:12.5px;line-height:1.32;text-align:justify;margin:0 0 2mm}
.signature-line{width:42mm;border-top:1px solid #000;text-align:center;font-weight:bold;margin:8mm 3mm 2mm auto;padding-top:1px;font-size:12px}
