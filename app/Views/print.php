...
.quality-sheet{width:209mm;min-height:296mm;margin:0 auto;background:#fff;border:1px solid #bfbfbf;padding:15mm 18mm 8mm;position:relative;display:block}
...
.equipment-table{margin-bottom:8mm;font-size:10.5px}
.equipment-table td{height:auto;min-height:0}
.observations{height:12mm;vertical-align:middle;line-height:1.18}
.assigned-title{font-weight:bold;margin:7mm 0 1.5mm 5mm;font-size:10.5px}
.assigned-table{margin-bottom:7mm;font-size:10.5px}
.legal-text{font-size:10.2px;line-height:1.34;text-align:justify;margin:0 0 2.1mm}
.signature-line{width:38mm;border-top:1px solid #000;text-align:center;font-weight:bold;margin:9mm 4mm 6mm auto;padding-top:1px;font-size:10px}
.quality-footer{border:1px solid #999;text-align:center;color:#777;font-size:7.5px;padding:1px;margin:0 4mm;position:absolute;left:18mm;right:18mm;bottom:8mm}
