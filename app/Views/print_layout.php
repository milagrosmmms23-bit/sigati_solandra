...
<head>
    ...
    <style>
@page{size:A4 portrait;margin:10mm 14mm 8mm}
...
.quality-sheet{width:100%;max-width:182mm;min-height:0;margin:0 auto;background:#fff;display:block}
.quality-table{width:100%;border-collapse:collapse;table-layout:fixed}
.quality-table td,.quality-table th{border:1px solid #222;padding:5px 6px;vertical-align:middle;line-height:1.18}
...
.quality-sign td{font-size:8px;height:auto;line-height:1.08;vertical-align:bottom;padding:2px 4px}
...
.equipment-table{margin-bottom:8.5mm;font-size:12px}
.equipment-table td{height:auto;min-height:0}
.observations{height:auto;vertical-align:top;line-height:1.2}
.assigned-title{font-weight:bold;margin:8mm 0 1.5mm 5mm;font-size:12px}
.assigned-table{margin-bottom:8mm;font-size:12px}
.legal-text{font-size:10.5px;line-height:1.38;text-align:justify;margin:0 0 2.1mm}
.signature-line{width:42mm;border-top:1px solid #000;text-align:center;font-weight:bold;margin:14mm 3mm 3mm auto;padding-top:1px}
